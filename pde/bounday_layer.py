...
parser.add_argument("--npoints", type=int, default=3000, help="the number of total dataset")
parser.add_argument("--ntest", type=int, default=3000, help="the number of testing dataset")
